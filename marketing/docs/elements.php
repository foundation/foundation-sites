...
<?php include("includes/_documentation_head.php"); ?>
	...
	<div class="row">
		<section role="main">
          ...
          <p>Easily toggle views to show which media query you are currently viewing. To activate the viewer, make sure you have <strong>jquery.foundation.mediaQueryToggle.js</strong> linked up on your page. From there, simply add the markup to your page or press <kbd>M</kbd>. The keyboard toggle won't work on mobile devices so make sure you add the markup in those cases.</p>
