...
;(function ($, window, document, undefined) {
  ...
  Foundation.libs.reveal = {
    ...
    open : function (modal, options) {
      ...
      // cache active modal
      this.active = this.active_object(modal);
      ...
      if (!this.active.locked) {
        ...
        if (this.settings.animation === 'fadeAndPop') {
          ...
          this.delay(function () {
            this.active.modal
              .animate({
                'top': $(this.scope).scrollTop() + this.active.top_measure,
                'opacity': 1
              },
    ...
    close_animation : function () {
      ...
      if (!this.active.locked) {
        ...
        if (this.settings.animation === 'fadeAndPop') {
          this.active.modal.animate({
            'top': $(this.scope).scrollTop() - this.active.top_offset + 'px',
            'opacity': 0
          },
        ...
        if (this.settings.animation === 'fade') {
          this.active.modal.animate({'opacity' : 0},
