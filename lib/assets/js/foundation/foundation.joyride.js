  ...
  Foundation.libs.joyride = {
    ...
    init : function (scope, method, options) {
      ...
      if (typeof method === 'object') {
        ...
        $.extend(true, this.settings, this.defaults);
      }
    ...
    start : function () {
      ...
      $.extend(true, this.defaults, this.settings, this.data_options($this));
      ...
      console.log(this.settings.cookieMonster, $.cookie(this.settings.cookieName))
      // generate the tips and insert into dom.
      if (!this.settings.cookieMonster || $.cookie(this.settings.cookieName) !== null) {
