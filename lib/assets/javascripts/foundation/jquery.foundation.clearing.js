  ...
  Foundation.libs.clearing = {
      ...
      if (typeof method != 'string') {
        $(this.scope).find('ul[data-clearing]').each(function () {
          ...
          if (!settings) {
            ...
            $el.data('fndtn.clearing.settings', $.extend({}, self.settings, options));
    ...
    events : function (el) {
      $(this.scope)
        ...
        .on('click.fndtn.clearing', '.clearing-main-right', function (e) { this.nav(e, 'next') }.bind(this))
        .on('click.fndtn.clearing', '.clearing-main-left', function (e) { this.nav(e, 'prev') }.bind(this))
        .on('click.fndtn.clearing', this.settings.close_selectors, this.close)
    ...
    swipe_events : function () {
      $(this.scope)
        .bind('swipeleft', 'ul[data-clearing]', function (e) { this.nav(e, 'next') }.bind(this))
        .bind('swiperight', 'ul[data-clearing]', function (e) { this.nav(e, 'prev') }.bind(this))
    ...
    shift : function (current, target, callback) {
      var clearing = target.parent(),
          old_index = this.settings.prev_index,
