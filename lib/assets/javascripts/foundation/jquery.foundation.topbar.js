  ...
  Foundation.libs.topbar = {
    ...
    init : function (scope, method, options) {
        ...
        $(this.scope)
          ...
          .on('click.fndtn.topbar', '.top-bar .has-dropdown>a', function (e) {
            ...
            if (methods.breakpoint()) {
              ...
              $this.siblings('ul').height(settings.height + self.settings.$titlebar.outerHeight(true));
              self.settings.$topbar.css('min-height', self.settings.height + self.settings.$titlebar.outerHeight(true) * 2)
            }
        });
      ...
      assemble : function () {
        ...
        this.settings.$section.appendTo(settings.$topbar);
      },
