  ...
  Foundation.libs.tooltips = {
    ...
    init : function (method, options) {
      ...
      if (typeof method != 'string') {
        ...
        if (Modernizr.touch) {
          $body.on('click.tooltip touchstart.tooltip touchend.tooltip', this.settings.selector, function (e) {
            e.preventDefault();
            $(this.settings.tooltipClass).hide();
            methods.showOrCreateTip($(this));
          });
          $body.on('click.tooltip touchstart.tooltip touchend.tooltip', this.settings.tooltipClass, function (e) {
            e.preventDefault();
            $(this).fadeOut(150);
          });
        } else {
          $body.on('mouseenter.tooltip mouseleave.tooltip', this.settings.selector, function (e) {
            var $this = $(this),
