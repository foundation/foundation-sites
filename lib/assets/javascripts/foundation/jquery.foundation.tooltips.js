  ...
  Foundation.libs.tooltips = {
    ...
    init : function (scope, method, options) {
      ...
      if (typeof method != 'string') {
        ...
        if (Modernizr.touch) {
          $(this.scope).on('click.tooltip touchstart.tooltip touchend.tooltip', this.settings.selector, function (e) {
            e.preventDefault();
            $(this.settings.tooltipClass).hide();
            methods.showOrCreateTip($(this));
          })
          .on('click.tooltip touchstart.tooltip touchend.tooltip', this.settings.tooltipClass, function (e) {
            e.preventDefault();
            $(this).fadeOut(150);
          });
        } else {
          $(this.scope).on('mouseenter.tooltip mouseleave.tooltip', this.settings.selector, function (e) {
            var $this = $(this),
    ...
    destroy : function () {
      ...
      // needs rewriting for this.scope
