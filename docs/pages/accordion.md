...
<ul class="accordion" data-accordion role="tablist">
  ...
  <li class="accordion-item">
    ...
    <div id="panel2d" class="content" role="tabpanel" data-tab-content aria-labelledby="panel2d-heading">
      Panel 2. Lorem ipsum dolor
    </div>
  </li>
  <li class="accordion-item">
    <a href="#panel3d" role="tab" class='accordion-title' id="panel3d-heading" aria-controls="panel3d">Accordion 3</a>
    <div id="panel3d" class="content" role="tabpanel" data-tab-content aria-labelledby="panel3d-heading">
