...
For an example of off-canvas on small screens and Top Bar Menu with Dropdowns, check out this Building Block: http://foundation.zurb.com/building-blocks/blocks/multilevel-offcanvas-menu.html
