...
For an example of responsive use of off-canvas on small screens and Top Bar on larger ones, check out this Building Block: http://foundation.zurb.com/building-blocks/blocks/multilevel-offcanvas-menu.html
