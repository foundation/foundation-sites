...
For an example of off-canvas, checkout this top bar with off-canvas navigation and dropdowns for submenus building block: <https://www.get.foundation/building-blocks/blocks/multilevel-offcanvas-menu.html>
