...
<div class="callout alert">
  <p><strong>From Foundation v6.4, the Float Grid is disabled by default</strong>, replaced by the new <a href="xy-grid.html">XY Grid</a>. Unless you need to support IE 10, it is recommended to use the XY Grid.</p>
</div>
