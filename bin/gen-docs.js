...
const TOKEN_GROUPS = ['scale', 'space', 'radius', 'width', 'text', 'font', 'hue', 'color', 'motion', 'layout', 'border', 'weight', 'shadow', 'control', 'button', 'badge', 'card', 'field', 'table', 'seam', 'nav', 'breadcrumbs', 'pagination', 'alert', 'progress', 'spinner'];
